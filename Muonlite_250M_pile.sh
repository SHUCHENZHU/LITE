...
BETA1=${BETA1:--0.25} #{-0.25,0.0}
BETA2=${BETA2:-1.0} #{0.5,1.0,2.0}

adamw_theta=${adamw_theta:-0.9} 

# LR_RATIO corresponds chi  in the paper
LR_RATIO_emb=${LR_RATIO_emb:-4.0}
LR_RATIO_out=${LR_RATIO_out:-1.0}
LR_RATIO_norm=${LR_RATIO_norm:-4.0}
LR_RATIO_qk=${LR_RATIO_qk:-2.0}
LR_RATIO_vo=${LR_RATIO_vo:-2.0}
LR_RATIO_ffn=${LR_RATIO_ffn:-2.0}
